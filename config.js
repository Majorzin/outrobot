...
module.exports = {
    ...
    BSL: process.env.OWNER_NUMBER === undefined ? 'default' : process.env.OWNER_NUMBER, 
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Catbot' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '554591233629@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'ᴄᴀᴛʙᴏᴛ' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '554591233629,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    BOTCREATOR: "Basilser",
    SUPPORT: "554591233629",
    SUPPORT2: "554591233629",
    SUPPORT3: "554591233629",
    SUPPORT4: "554591233628"
};
